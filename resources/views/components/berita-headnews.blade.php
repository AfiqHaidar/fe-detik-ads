    ...
    <div class="h-1/4 px-5 py-2  grow flex flex-col justify-center w-full items-start bg-[#00D1FF] rounded-b-2xl">
        <div class="text-white font-semibold xl:text-2xl lg:text-xl md:text-md text-sm group-hover:text-[#FFE03C] transition-colors duration-300">
            {{ $headline }}
        </div>
        <div class="text-white font-normal xl:text-lg lg:text-md md:text-sm text-xs mt-2 ">
            {{ $time }}
        </div>
    </div>
